...
import com.nowni.JetpackComposeProject.apps_list2.Desert_Clicker_ViewModel.ui.DessertClickerViewModel
...
import com.nowni.JetpackComposeProject.apps_list3.OpenStreetMap.OpenStreetMapMainActivity
            ...
            ComposeProjectLayout(
                ...
                onItemClick = { listId ->
                    val activityClass = when (listId) {
                        ...
                        17 -> DessertClickerViewModel::class.java
                        18 -> OpenStreetMapMainActivity::class.java
                        else -> null
                    }
                    activityClass?.let {
